...
void display( void )
{
    ...
    glRotatef( joystick_lever[0] * 45.0, 0.0, 1.0, 0.0 ); /*Ｙ軸について回転*/
    glRotatef( joystick_lever[1] * 45.0, 1.0, 0.0, 0.0 ); /*Ｘ軸について回転*/
...
void specialkey( int key, int x, int y)
{
    switch (key) {
      case GLUT_KEY_LEFT:
        joystick_lever[0] -= 0.05;
        break;
      case GLUT_KEY_RIGHT:
        joystick_lever[0] += 0.05;
        break;
      case GLUT_KEY_UP:
        joystick_lever[1] -= 0.05;
        break;
      case GLUT_KEY_DOWN:
        joystick_lever[1] += 0.05;
        break;
      case GLUT_KEY_F1: /*■[F1]キー*/
        printf( "[F1] is pressedn\n" );
        break;
      default:
        break;
    }
...
int main( int argc, char *argv[] )
{
    ...
    glutSpecialFunc(specialkey); /*■特殊キー入力のコールバック関数の指定*/
